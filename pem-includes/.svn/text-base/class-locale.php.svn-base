<?php
/* ========================== FILE INFORMATION ================================= 
This class was originally developed for WordPress 2.1.  It has been reworked 
for use with PEM. 
============================================================================= */
...
{
   return $weekday_initial[$weekday_name];
}   

function get_weekday_abbrev($weekday_name) 
{
   return $weekday_abbrev[$weekday_name];
}   

function get_month($month_number) 
{
   return $month[zeroise($month_number, 2)];
}   

function get_month_initial($month_name) 
{
   return $month_initial[$month_name];
}   

function get_month_abbrev($month_name) 
{
   return $month_abbrev[$month_name];
}   

function get_meridiem($meridiem) 
{
   return $meridiem[$meridiem];
}   
