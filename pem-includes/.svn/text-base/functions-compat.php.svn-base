<?php
/* ========================== FILE INFORMATION ================================= 
phxEventManager :: functions-compat.php

Functions missing from older PHP versions.  With additional requirements pushing 
the move to PHP5, the value of this include is in question.  For now it is added 
for assured backward compatibility, but it will likely be removed in a future 
update.  

Unless states otherwise, the following functions originate from WordPress.
============================================================================= */
