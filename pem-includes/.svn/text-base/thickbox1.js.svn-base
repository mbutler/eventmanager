 ...
 *
 * Hacks made to this code for PEM for fixed positioning.
...
function TB_show(caption, url, rel) {
	...
	//$(window).scroll(TB_position); Removed with fixed positioning hack

	// TODO replace
	TB_overlaySize();

	// TODO create loader only once, hide and show on demand
	$("body").append('<div id="TB_load"><img src="/pem-includes/loadingAnimation.gif" /></div>');
	TB_load_position();
	...
	// $(window).resize(TB_position); Removed with fixed positioning hack
